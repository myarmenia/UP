...
;(function(window) {
    ...
    // document.querySelector('.view').offsetWidth
	...
	TabsNav.prototype._initEvents = function() {
		...
		enquire.register('screen and (min-width:0) and (max-width:767px)', { 
			match: function() {
	...
	TabsNav.prototype._openTab = function(tab) {
        ...
        // смещение навигации табов
        if(window.matchMedia('(min-width: 1920px)').matches){
            this.dim = {
                measure: this.options.layout === 'vertical' ? currentDimensions.width : currentDimensions.height,
                position: this.options.layout === 'vertical' ? currentDimensions.left - 110 : currentDimensions.top,
        ...
        if(window.matchMedia('(max-width: 1620px)').matches && window.matchMedia('(min-width: 1500px)').matches){
            this.dim = {
                measure: this.options.layout === 'vertical' ? currentDimensions.width : currentDimensions.height,
                position: this.options.layout === 'vertical' ? currentDimensions.left - 20 : currentDimensions.top,
                win: this.options.layout === 'vertical' ? win.width : win.height
            };
        }
        if(window.matchMedia('(max-width: 1280px)').matches){
            this.dim = {
                measure: this.options.layout === 'vertical' ? currentDimensions.width : currentDimensions.height,
                position: this.options.layout === 'vertical' ? currentDimensions.left - 66 : currentDimensions.top,
                win: this.options.layout === 'vertical' ? win.width : win.height
            };
        }
        ...
        if(window.matchMedia('(max-width: 991px)').matches){
            this.dim = {
                measure: this.options.layout === 'vertical' ? currentDimensions.width : currentDimensions.height,
                position: this.options.layout === 'vertical' ? currentDimensions.left - 40 : currentDimensions.top,
                win: this.options.layout === 'vertical' ? win.width : win.height
            };
        }
